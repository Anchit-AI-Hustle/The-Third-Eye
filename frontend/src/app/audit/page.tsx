...
const AUDITS: Audit[] = [
  ...
  },
  {
    ...
    target: 9.5,
    dims: { accuracy: 8, implementation: 8, execution: 8, results: 8 },
    verdict: "Capture and persistence now work through the server route. Debouncing autosave is the remaining polish.",
    issues: [
  ...
  },
  {
    ...
    verdict: "Persistence now works through the server route. A divide-by-zero in the progress maths still needs guarding.",
    issues: [
      { severity: "high", text: "Division by zero when a goal has target 0 → NaN% progress.", fix: "Guard the denominator; show 0% for empty goals.", status: "pending" },
