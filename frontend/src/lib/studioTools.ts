...
export const STUDIO_TOOLS: StudioTool[] = [
  ...
  },
  {
    ...
    icon: "Music",
    accent: "#34D399",
    blurb: "Generate actual music — an audio track you can play and download — from a description. Instrumental or with AI vocals + lyrics.",
    format: "markdown", // custom UI (audio player); handled by MusicStudio, not the generic workbench
    downloadExt: "mp3",
    cta: "Generate music",
    fields: [],
  },
  {
    ...
    icon: "PenLine",
    accent: "#F0C94E",
    blurb: "Text-only creative: song lyrics, a ready-to-paste music-gen prompt, poems, or social captions from a brief.",
    format: "markdown",
    downloadExt: "md",
    cta: "Create",
    fields: [
