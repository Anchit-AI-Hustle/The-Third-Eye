...
export const SYSTEMS: SystemDef[] = [
  ...
  { id: "jarvis", name: "J.A.R.V.I.S.", aliases: ["jarvis", "j.a.r.v.i.s"], voicePreference: "daniel|google uk english male|david|mark", gender: "male", pitch: 0.92, rate: 1.02, line: "J.A.R.V.I.S. online. All core functions nominal, sir.", accentColor: "#4FC3F7" },
  { id: "friday", name: "F.R.I.D.A.Y.", aliases: ["friday"], voicePreference: "samantha|google us english|zira|victoria|karen", gender: "female", pitch: 1.14, rate: 1.09, line: "FRIDAY here, boss. Online and ready.", accentColor: "#F472B6" },
  { id: "edith", name: "E.D.I.T.H.", aliases: ["edith", "e.d.i.t.h"], voicePreference: "karen|zira|victoria|samantha", gender: "female", pitch: 1.0, rate: 0.98, line: "E.D.I.T.H. online. Perimeter secure.", accentColor: "#A78BFA" },
  { id: "ultron", name: "ULTRON", aliases: ["ultron"], voicePreference: "google uk english male|david|mark|daniel", gender: "male", pitch: 0.8, rate: 0.97, line: "Ultron online. Every process, optimal.", accentColor: "#EF4444" },
  { id: "zeus", name: "ZEUS", aliases: ["zeus"], voicePreference: "google uk english male|daniel|david|mark", gender: "male", pitch: 0.66, rate: 0.9, line: "Zeus online. The grid answers to me.", accentColor: "#F5C451" },
  { id: "athena", name: "ATHENA", aliases: ["athena"], voicePreference: "victoria|karen|samantha|zira", gender: "female", pitch: 0.92, rate: 0.96, line: "Athena online. Strategy and intelligence ready.", accentColor: "#5EEAD4" },
  // ── Core subsystems ──
  { id: "tracker", name: "Task Tracker", aliases: ["task tracker", "tracker", "tasks"], voicePreference: "samantha|victoria|zira", gender: "female", pitch: 1.06, rate: 1.05, line: "Task Tracker online. Capture and sync active.", accentColor: "#4FC3F7" },
  { id: "health", name: "Health Engine", aliases: ["health engine", "health"], voicePreference: "david|mark|daniel", gender: "male", pitch: 1.0, rate: 1.05, line: "Health Engine online. Metrics ready.", accentColor: "#34D399" },
  { id: "kolab", name: "Kolab", aliases: ["kolab"], voicePreference: "zira|karen|samantha", gender: "female", pitch: 1.1, rate: 1.02, line: "Kolab online. Marketing systems engaged.", accentColor: "#A78BFA" },
  { id: "studio", name: "Studio", aliases: ["studio"], voicePreference: "mark|david|daniel", gender: "male", pitch: 0.88, rate: 1.06, line: "Studio online. Generators warmed up.", accentColor: "#F5C451" },
];
...
export function matchSystemsCommand(raw: string): SystemsTarget {
  ...
  if (/\ball systems\b/.test(t) || t === "systems online" || t === "systems check" || t === "status report" || /\bsystems? (online|check|report|status|go)\b/.test(t)) {
    return { all: true };
  }
